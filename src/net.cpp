...
unsigned int pnSeed[] =
{
    ...
    0xCEFD2305, 0xF3F1E917, 0x512482B2, 0xB73219B9,
    0x49F4C8C3, 0xA989CA95, 0xEE3319B9, 0x3E5AD459,
    0xB5F4FCD5, 0xC13219B9, 0x0CF4FCD5, 0x03F92305,
    0x9C713A4D, 0x4492175E, 0x171A9ABC, 0xE98451AC,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SpreadCoin is probably already running."), addrBind.ToString().c_str());
        else
